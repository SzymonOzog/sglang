...
class DeepseekV2AttentionMLA(nn.Module):
    ...
    def __init__(
        ...
        if self.q_lora_rank is not None:
            ...
            self.q_a_layernorm = RMSNorm(self.q_lora_rank, eps=config.rms_norm_eps, output_quant=False)
...
class DeepseekV2DecoderLayer(nn.Module):
    ...
    def __init__(
        ...
        self.input_layernorm = RMSNorm(config.hidden_size, eps=config.rms_norm_eps, output_quant=False)
